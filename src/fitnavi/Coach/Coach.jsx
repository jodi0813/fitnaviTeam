...
function Coach() {
  ...
  // const cardSectionRef = useRef(null); // 區塊滾動用
  ...
  const handleSearch = (e) => {
    ...
    const result = coachList.filter((coach) => {
      ...
      const matchSex = selectedSex === "" || coach.性別 === selectedSex;
      const matchHashtag =
    ...
    <>
      <div id="coachMain">
        ...
        <div className="searchBox">
          <form onSubmit={handleSearch} id="personal-search-form" title="健身教練搜尋">
            {/* 搜尋地區 */}
            <select
              name="area"
              id="area"
        ...
        {/* 教練卡牌 */}
        <div className="allCoachCards" id="coachCardsSection">{/* ref={cardSectionRef}  */}
            ...
            <div>
              ...
              {pageCount > 1 && (
                <PaginationComponent
                  ...
                  currentPage={currentPage} // 傳入當前頁碼
...
//           <PaginationComponent
//             totalPages={10}
//             onPageChange={(page) => console.log('目前在第', page, '頁')}
//           />
