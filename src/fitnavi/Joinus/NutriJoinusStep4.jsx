...
function NutriJoinusStep4() {
    const navigate = useNavigate();
    return (
        <>

            <section id='NuriJoinusStep4-Form'>

                <MainTitle title1="加入我們" title2="成為我們的合作夥伴" />



                <div className='NutriJoinus-Step4-wrapper'>
                    <form action="" className='NutriJoinus-Step4'>
                        ...
                        <div className='PreSSendButton'>
                            <button onClick={() => { navigate('/NutriJoinusStep3'); window.scrollTo(0, 0); }}>◀ 上一步</button>
