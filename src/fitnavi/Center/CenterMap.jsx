...
//                   </div>
//                   <div className="checkboxItem">
//                     <input type="checkbox" name="order" id="order16" />
//                     <label htmlFor="order16">皮拉提斯</label>
//                   </div>
//                   <div className="checkboxItem">
//                     <input type="checkbox" name="order" id="order17" />
//                     <label htmlFor="order17">TRX懸吊訓練</label>
//                   </div>
//                   <div className="checkboxItem">
//                     <input type="checkbox" name="order" id="order18" />
//                     <label htmlFor="order18">伸展放鬆</label>
//                   </div>                             
//                   <div className="checkboxItem">
//                     <input type="checkbox" name="order" id="order19" />
//                     <label htmlFor="order19">瑜珈</label>
//                   </div>
//                 </fieldset>
