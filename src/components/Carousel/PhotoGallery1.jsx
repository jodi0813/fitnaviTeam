...
//     // 限制滑動範圍
//     const maxOffset = 0;
//     const minOffset = -(images.length * (MOBILE_IMG_WIDTH + MOBILE_GAP) - VISIBLE_WIDTH + LEFT_PADDING);
...
//     const maxOffset = 0;
//     const minOffset = -(images.length * (MOBILE_IMG_WIDTH + MOBILE_GAP) - VISIBLE_WIDTH + LEFT_PADDING);
//     const finalOffset = Math.max(minOffset, Math.min(maxOffset, snapPosition));
...
//               width: `${images.length * (MOBILE_IMG_WIDTH + MOBILE_GAP) + LEFT_PADDING}px`,
//             }}
//           >
