// 教練卡牌種子資料
// 用於將教練資料匯入 Firebase Firestore（見 scripts/seedCoaches.mjs）
// 每筆資料的 id 會作為 Firestore 文件 ID
export const coachSeedData = [
  {
    id: "lila",
    name: "張莉筠 Lila",
    role: "教練",
  ...
  },
  {
    ...
    description: "訓練就是要全力以赴！專注提升肌力與爆發力，打造強悍的運動表現。",
  ...
  },
  {
    ...
    description: "融合皮拉提斯與核心訓練，強化深層肌群，讓你內外兼具的美與力。",
  ...
  },
  {
    ...
    description: "幫助你改善身體姿勢與不適，建立正確的動作模式，讓訓練更安全有效。",
  ...
  },
  {
    ...
    description: "TRX訓練是我的強項，帶你有效強化核心、燃燒脂肪、提升協調性。",
  ...
  },
  {
    ...
    description: "不管你是健身新手或想減脂瘦身，我都能幫你找到合適的開始方式。",
  ...
  },
  {
    ...
    description: "從基礎體能做起，打造扎實體態，漸進式提升你的每一寸肌肉力量。",
  ...
  },
  {
    ...
    description: "循序漸進的健身計劃，最適合剛開始運動的你，一步步建立好習慣。",
